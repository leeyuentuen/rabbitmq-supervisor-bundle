...
class RabbitMqSupervisorExtension extends Extension implements PrependExtensionInterface
{
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->setParameter('phobetor_rabbitmq_supervisor.supervisor_instance_identifier',
            $config['supervisor_instance_identifier']);
        $container->setParameter('phobetor_rabbitmq_supervisor.sock_file_permissions',
            $config['sock_file_permissions']);
        ...
        $container->setParameter('phobetor_rabbitmq_supervisor.configuration_file',
            $config['paths']['configuration_file']);
